...
def load():
    if os.path.isfile('C:/Users/shrey/OneDrive/Desktop/aip/old_brain4.pth'):
        print("=> loading checkpoint... ")
        checkpoint = torch.load('C:/Users/shrey/OneDrive/Desktop/aip/epochs/old_brain4.pth')
...
def save():
        torch.save({'state_dict': cnn.state_dict(),
                   ...
                   }, 'C:/Users/shrey/OneDrive/Desktop/aip/old_brain5.pth')


# Training the AI
nb_epochs = 19 #Modify this to get better results (We were able to train only for 20 epochs at once)
